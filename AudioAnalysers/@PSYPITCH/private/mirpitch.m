...
% Also the name of the class was changed (everywhere in Psysound3) into 'PSYPITCH' (instead of 'mirpitch')
% (This last modification is unuseful, but I had already written the class
% constructor for Psysound3 using 'PSYPITCH'when I realized errors occured because of that, so I renamed each
% 'mirpitch' into 'PSYPITCH') 
