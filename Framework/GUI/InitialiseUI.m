...
handles.RunAnalysis = uicontrol(...
 ...
 handles.ParallellComputing = uicontrol(...
            'Style', 'popupmenu', ...
            'FontSize', 9, ...            
            'Parent', handles.ResamplingPanel, ...
            'Tag', 'ParallellPopup', ...
            'Units', 'Characters',...
            'Position', [1*CharWide 4.5 1.2*buttonWidth buttonHeight], ...
            'String', 'None|On files|On analysers', ...
            'UserData', [1, 2, 3], ...
            'BackgroundColor',bgColor);

handles.ParallellComputingText = uicontrol(...
            'Style', 'text', ...
            'FontSize', 9, ...            
            'Parent', handles.ResamplingPanel, ...
            'Units', 'Characters',...
            'Position', [2*CharWide 7*CharHi 15*CharWide 1*CharHi], ...
