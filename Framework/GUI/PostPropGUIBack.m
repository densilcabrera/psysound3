...
%
function out = createAudioTSeriesPopup(fName)
...
function out = createDefaultPopup
  menu = javax.swing.JPopupMenu;
  item = javax.swing.JMenuItem('No selections for this node');
