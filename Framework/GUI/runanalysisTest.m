...
matlabpool open
    ...
    runanalysisParr(fileHandles, analysers, syncPeriod, wH,MirOptionStr,Frame,Name,parOnFiles,varargin);
...
%     savedsArrAudioTemp(dsArrAudioTemp{i}, dataSaveDir,num2str(i));
...
function savedsArrAudioTemp(dsArr, path2Dir,i)

% Build up the full path - the dir should already exist
saveDir = fullfile(path2Dir, ['dataInfo',i,'.mat']);
