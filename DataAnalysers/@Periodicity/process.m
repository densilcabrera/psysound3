...
data = TSObj.data;
time = TSObj.time;
fs =1/dataObjS.DataObj.TimeInfo.Increment;
wl = floor(fs /2);
...
% vibrato = Vibrato(data, time, fs, wl);
% summary = {'Extent','Checkthis',vibrato.ExtAvg};
% addSummaryToNode(obj, dataObjS, node, summary);
...
ExtentStats = RateTS(ExtentStatsI);
...
summary3 = {'Median Extent','',ExtentMed};
summary4 = {'Std. Dev Extent','',ExtentStD};
addSummaryToNode(obj, dataObjS, node, summary1, summary2,summary3,summary4);
